...
public class LynxAppMailConfigProfile extends AbstractBaseProfile {
    private Map<String, Boolean> fieldVisibility = new HashMap<>();
    private LynxAppMailConfigWindow window;
    
    public LynxAppMailConfigProfile(LynxAppMailConfigWindow window) {
        super(window);
        this.window = window;
        initProfiles();
    }
